...
export const HIRE_DEVELOPER_DATA: DETAILS_DATA[] = [
  ...
  },
  {
    ...
    bannerHeading: "Hire PHP Developers",
    bannerDescription:
    ...
    description: [
      {
        label:
          "Hire experience PHP Developers from Employ Virtual to build secure, fast and performance driven website for your business. PHP web development services provides feature-rich applications of different magnitude and complexity; it can be your ecommerce website, CMS based website, web portals to social networking websites.",
      },
      {
        label:
          "Hire experience PHP Developers from Employ Virtual to build secure, fast and performance driven website for your business. PHP web development services provides feature-rich applications of different magnitude and complexity; it can be your ecommerce website, CMS based website, web portals to social networking websites.",
      ...
      {
        label:
          "Employ Virtual PHP Developers have vast experience to write codes. Our developers keep on refreshing their knowledge through comprehensive trainings with latest techniques and methodologies to meet your expectations. Hire our PHP Developers for simple and complex enterprise-level websites and web applications.",
      },
    ],
    details_list: [
      {
        heading:
          "Few basic things need to be taken care while hiring PHP Developer:",
        data: [
          {
            label:
              "A right hire is one who have experience of various techniques used in web development and its implementation.",
          },
          {
            label:
              "Knowledge of PHP and HTML programming language should be in-depth.",
          },
          {
            label:
              "Previous proven work experience in PHP project is every crucial and essential.",
          },
          { label: "Proficient technical knowledge and experience." },
          { label: "Capable of dealing with changing client’s need." },
          { label: "Able to test the website before deployment." },
          { label: "Eagerness to learn new tools and techniques." },
        ],
      },
      {
        heading: "Why hire PHP Developer from Employ Virtual?",
        data: [
          {
            label:
              "A right hire is one who have experience of various techniques used in web development and its implementation.",
  ...
  },
  {
    ...
    bannerHeading: "Hire Magento Developers",
    bannerDescription:
    ...
    description: [
      {
        label:
          "Hire the Magento Developers for your ecommerce store from Employ Virtual. They are expertise in building a user friendly, enriched with latest features, SEO friendly ecommerce portals. We aim at delivering complete ecommerce development solutions and take your business to the next stage. The expert will be in-charge of developing, maintaining and improving your e-commerce websites.",
      },
      {
        label:
          "The Magento professionals are into designing and developing the most customized online store development solutions to fit the business need, your budget with higher ROI. Before starting with a project our experts start with their research and development process, so you get the online store of your choice. We are here to improvise your online presence with our new-edge solutions.",
      },
      {
        label:
          "At Employ Virtual you will be able to rely on our Magento Developers to help with both Magento Community and Enterprise edition. Our Magento developers have gained their experience in providing the Magento development services from themes design and development to 3rd party integrations.",
      },
    ],
    details_list: [
      {
        heading:
          "Few basic things need to be taken care while hiring Magento Developer:",
        data: [
          {
            label:
              "Have a clear and projected understanding of your requirements.",
          },
          {
            label:
              "The certified Magento Developer should have sound knowledge on technical aspects with professional expertise.",
          },
          {
            label:
              "There should be a clear understanding about your project, project requirements and its effect on the outcome of the project.",
          },
          {
            label:
              "There should be continuous communication between the professional and the client to have an uninterrupted flow of information.",
          },
          {
            label:
              "It is also necessary to develop SEO friendly Magento Online Store.",
          },
          { label: "No compromise on quality." },
        ],
      },
      {
        heading: "Why hire Magento Developer from Employ Virtual?",
        data: [
          {
            label:
              "Our professionals understand the criticality of an ecommerce online store, so paying attention to the project and details is the primary requirement.",
          },
          {
            label:
              "Our developers are well-versed in JavaScript, Magento (Adobe Commerce), PHP, CSS, HTML and MySQL.",
          },
          {
            label:
              "Our experts have in-depth understanding of UI/UX trends and complete ecommerce lifecycle development.",
          },
          {
            label:
              "They have project management ability and work ethics while managing the project timeline.",
          },
          {
            label:
              "Our professionals have sound knowledge of SEO, Google Analytics, Google Tag Manager, A/B Testing, PPC, Adobe Illustrator and Adobe Photoshop.",
          },
        ],
      },
    ],
  },
  {
    ...
    bannerHeading: "Hire Android Developers",
    bannerDescription:
    ...
    description: [
      {
        label:
          "The Android Developers from Employ Virtual are experts in designing and developing scalable and fully-functional mobile applications solutions for small, mid-scale businesses across diverse industry verticals. We at Employ Virtual are here to turn your dream project into solid reality with vast talent pool of Android Developers.",
      },
      {
        label:
          "Our Developers will integrate seamless applications that are highly efficient and user-friendly that combines irresistible features to suit your business. Our experts are well-versed in cutting-edge technology to develop applications aligned to your business needs. Our developers understand the demand of diverse businesses and deliver world-class solutions. Empowered with modern tools and technologies, our skilled Android Developers build ultra-modern applications to deliver great customer experience.",
      },
      {
        label:
          "The Android Developers at Employ Virtual are highly experienced and reliable for your project design, development and deployment. Their job does not end here, they will also test and debug your application at times of vulnerability issues.",
      },
    ],
    details_list: [
      {
        heading:
          "Few basic things need to be taken care while hiring Android Developer:",
        data: [
          { label: "Define your project requirements." },
          { label: "Experience and knowledge of the Android Developer." },
          {
            label:
              "It's better to hire Android Developer with wide Android Open-Source Knowledge.",
          },
          {
            label:
              "It's good to have a developer with previous development track records.",
          },
          {
            label:
              "Apart from these, it’s a must to have soft skills to understand client’s business and project requirement.",
          },
        ],
      },
      {
        heading: "Why hire Android Developer from Employ Virtual?",
        data: [
          {
            label:
              "Our experts have in-dept knowledge on latest Android tools and technologies.",
          },
          {
            label:
              "They have versatile experience and can develop applications with advanced image processing or Augmented Reality, so that they can incorporate video/audio streaming, application connect to external loT hardware, advanced animations, external services like payment SDK/Firebase and application security.",
          },
          {
            label:
              "Our professionals are well-versed with Java and Kotlin languages, XML, Android Jetpack, material design, Android Studio, Android SDK, UI testing like espresso and Unit testing with Mockito/Mockk.",
          },
          {
            label:
              "Our Android Developers have successfully worked with open libraries of the Android world like Retrofit, Glide/Picasso, RxJava, RxAndroid, Dagger/Koin.",
          },
          {
            label:
              "Our professionals have expertise in modern Android UI with implementing navigation for the users.",
          },
          {
            label:
              "They are versatile in working with local database like Room database, Jetpack’s Datastore, Data Binding Library.",
          },
          { label: "They can access data over network like Retrofit 2." },
        ],
      },
    ],
  },
  {
    ...
    bannerHeading: "Hire iOS Developers",
    bannerDescription:
    ...
    description: [
      {
        label:
          "The iOS Developers from Employ Virtual are known for their excellent hold on coding and other technical skills required for iOS application development. The professional will design the software and applications for iOS ecosystem according to your business need. Our professionals are highly experienced and innovative which will in turn lead to remarkable growth in your business with increased profitability, productivity and user footfall.",
      },
      {
        label:
          "Our iOS Developers has made many iOS applications and made them live on apple iTunes. Our experts are well-versed in both scratch development and development on existing codebase for new changes and amendments and bug fixings.",
      },
      {
        label:
          "Our iOS Developers will design, develop and deploy interactive and scalable mobile applications based on your business need using latest and modern technologies and methodologies. The developed iOS application will be customer focused, innovative and enriched with features. For custom iOS application development, our experts are well-trained in technologies such as AR/VR, Blockchain, AI/ML, IoT, and more.",
      },
    ],
    details_list: [
      {
        heading:
          "Few basic things need to be taken care while hiring IOS Developer:",
        data: [
          {
            label:
              "The hire should be an expert at least in two programming languages that are used in iOS coding, i.e., Objective-C and Swift.",
          },
          {
            label:
              "More the diversity of project work of an iOS hire, more will be benefit for your project.",
          },
          {
            label:
              "Knowledge of iOS SDK and Frameworks such as Cocoa Touch, Foundation, UIKIt.",
          },
          { label: "Expert in Architectural patterns such as MVC, MVVM." },
          {
            label:
              "The expert should be able to use Networking tools such as REST, GraphQL.",
          },
          {
            label:
              "Hand-on experience on UI/UX such as XIB, Storyboards, Apple Interface Guidelines.",
          },
          {
            label: "Good communication for clear understanding of the project.",
          },
        ],
      },
      {
        heading: "Why hire IOS Developer from Employ Virtual?",
        data: [
          { label: "Work experience as an iOS developer." },
          {
            label: "Experience in Objective-C, Swift, Xcode, and Cocoa Touch.",
          },
          { label: "Knowledge of iOS back-end services." },
          {
            label:
              "Proficient in iOS Frameworks such as Core Data, Core Graphics, and Core Animation.",
          },
          {
            label:
              "Knowledge of Apple’s design principles and application interface guidelines.",
          },
          { label: "Understanding of the mobile development life cycle." },
          { label: "Knowledge of code versioning tools, like Git." },
          { label: "Familiarity with C-based libraries." },
          {
            label:
              "Knowledge of push notifications, APIs, and cloud messaging.",
          },
          { label: "Experience with continuous integration." },
          {
            label:
  ...
  },
  {
    ...
    bannerHeading: "Hire Frontend Developers",
    bannerDescription:
    ...
    description: [
      {
        label:
          "Employ Virtual lets you hire your Front-end experts with T-shaped skills who will collaborate with experts from other disciplines and use the knowledge from such collaboration to your advantage and work. Your dedicated Front-end developer will make best use of languages, design, scripts, frameworks and will develop HTML, CSS and JavaScript for a website or web application, so that a user can see and interact with it directly and that the application design works online.",
      },
      {
        label:
          "Our Front-end developers follows best coding practices and adherence to HTML5, CSS3, JavaScript, SEO and WCAG2 guidelines. They will be responsible for Unit Testing, code review, code quality metrics. Our experts are top Front-end talent pre-vetted for a perfect fit for your project.",
      },
      {
        label:
          "Our Front-end Developers bring top-scoring combination of expertise and experience on table.  We are here to guide you and help with hiring Front-end Developers experienced in multiple domains including retail, e-commerce, businesses, content management, financial and non-financial services, healthcare, pharmaceuticals and many more.",
      },
    ],
    details_list: [
      {
        heading:
          "Few basic things need to be taken care while hiring Front-end Developer:",
        data: [
          { label: "Working knowledge of HTML and HTML5." },
          {
            label:
              "Understanding of Web sockets, Canvas with improved video, audio, and geolocation support.",
          },
          { label: "Understanding of CSS Grid." },
          { label: "Understanding of semantic HTML." },
          {
            label:
              "Exceptional soft skills and analytical skills to understand the project.",
          },
        ],
      },
      {
        heading: "Why hire Front-end Developer from Employ Virtual?",
        data: [
          { label: "Our experts understand the key principles of web design." },
          {
            label:
              "They are well-versed with HTML, CSS, JavaScript, and jQuery.",
          },
          {
            label: "They are able to work with JavaScript and CSS frameworks.",
          },
          { label: "They are able to use CSS pre-processors." },
          {
            label:
              "Strong understanding of architectural approaches to API design, principles of work of proxy-servers and other web-servers used in the system.",
          },
          {
            label:
              "They understand RESTful API/GraphQL, ES6 (classes, variables, and visibility range, array methods, async/await), Typescript (types, decorators, interfaces).",
          },
          {
            label:
              "Well-versed with known version control system and other tools of development.",
          },
          { label: "They are able to create an adaptive design." },
          { label: "They can use web-application testing tools." },
        ],
      },
    ],
  },
  {
    ...
    bannerHeading: "Hire HTML Developers",
    bannerDescription:
    ...
    description: [
      {
        label:
          "Hire your HTML Developer from Employ Virtual who uses HTML to create website layouts based on templates and wireframes. The experts are dedicated to scale up your business or product to save upto 50% on all development, maintenance and support costs.",
      },
      {
        label:
          "Our experts will incorporate the power of HTML/HTML5 into your business. Our qualified and experienced team will meet your web/mobile aspirations successfully without any hassle of trying to find the right developers to help achieve your business goal. You will get your dedicated HTML Developer or a team of HTML Developers working for your project. They come up with handcrafted solutions for your business. All the solutions are designed and developed with latest technology and tools. Also, the team ensures that there is bug free and glitch free web designs.",
      },
      {
        label:
          "Our experts will work as your in-house team with an assurance of quality product deliverance. Our professionals have in-depth knowledge of front-end coding languages such as HTML, CSS, JavaScript and XML. In case of sudden issue with the coding, they are able to troubleshoot coding and application errors.",
      },
    ],
    details_list: [
      {
  ...
  //   infrastructure & cloud
  {
    ...
    bannerHeading: "Cloud Consulting",
    bannerDescription:
      "Cloud consulting is the process where the businesses consult expert cloud consultants to build, operate, manage and maintain an optimal cloud environment.",
    img: cloudConsulting,
    heading: "Cloud Consulting",
    description: [
      {
        label:
          "Cloud consulting is the process where the businesses consult expert cloud consultants to build, operate, manage and maintain an optimal cloud environment. This accelerates business growth and innovation, drives transformation, agility, increases operational efficiency with secured cloud functionality.",
      },
      {
        label:
          "The cloud consultant will guide you to choose from wide range of cloud solutions and products that will work together seamlessly and provide the highest return on your technology. Our consultant will help you to choose the ideal cloud plan.",
      },
    ],
    details_list: [
      {
