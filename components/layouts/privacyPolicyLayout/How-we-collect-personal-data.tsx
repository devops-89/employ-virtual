  ...
  const data = [
    {
      ...
      listDetails: [
        ...
        {
          label: "Automated technologies or interactions",
          value:
        ...
        {
          label: "Third parties or publicly available sources",
          value:
            "We may obtain personal information about you from third parties and public sources, as detailed below:Public Meetings. DIGIXITO accepts no responsibility or liability for personal information that you post in public forums or otherwise make public. We reserve the right, but not the duty, to monitor and remove information from comment areas, message boards, events, and other interactive sections of the Services.",
        },
        {
          label: "Technical Data from the following parties:",
          listData: [
            {
              label:
    ...
    },
    {
      ...
      tableData: {
        ...
        tableData: [
          {
            purpose: {
              title: "To register you as a new customer",
            },
            type_of_data: {
              data: [
                {
                  label: "(a) Identity Data",
                },
                {
                  label: "(b) Contact Data",
                },
              ],
            },
            lawful: {
          ...
          {
            purpose: {
              title: "To process and deliver your order including:",
              data: [
                {
                  label: "(a) Manage payments, fees and charges",
                },
                {
                  label: "(b) Collect and recover money owed to us",
                },
              ],
            },
            type_of_data: {
              data: [
                ...
                {
                  label: "(c) Marketing and Communications Data",
                },
              ],
            },
            lawful: {
              data: [
                {
                  label: "(a) Performance of a contract with you",
                },
                {
                  label:
          ...
          {
            purpose: {
              title: "To manage our relationship with you which will include:",
              data: [
                {
                  label:
                ...
                {
                  label: "(b) Asking you to leave a review or take a survey",
                },
              ],
            },
            type_of_data: {
              data: [
                ...
                {
                  label: "(c) Profile Data",
                },
                {
                  label: "(d) Biometric Data",
                },
                {
                  label: "(e) Marketing and Communications Data",
                },
              ],
            },
            lawful: {
              data: [
                ...
                {
                  label: "(b) Necessary to comply with a legal obligation",
                },
                {
                  label:
